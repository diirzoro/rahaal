// Rahaal Extension — Content Script v1.2
// Uses shared window.RahalParsers.scrape() from parsers.js (loaded before this file in manifest).
// Exposes: window.__RAHAL_SCRAPE__() → unifiedSchema | null
//          window.__RAHAL_OPEN_WIDGET__(payload) → in-page widget

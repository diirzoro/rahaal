...
export const ADMIN_SECTIONS = [
  ...
  { key: 'commissions', label: 'العمولات', actions: ['view', 'export', 'create', 'approve', 'manage'] },
  { key: 'requests', label: 'مركز الطلبات', actions: ['view', 'create', 'edit', 'approve', 'manage'] },
...
const ROUTE_SECTIONS = [
  ...
  ['/admin/staff/', 'staff'],
  // v4.8 — PR#18-2: orders + commissions-ledger were falling into the 'offices'
  // fallback (an offices_manager could write to them). Bound to their real sections;
  // fine-grained per-action checks live inside adminOrders.js handlers.
  ['/admin/orders', 'requests'],
  ['/admin/commissions-ledger', 'commissions'],

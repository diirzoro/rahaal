...
async function reportIncome(db, T, q) {
  ...
  return { revenue: rev, expenses: exp, total_revenue_usd: +totalRevUsd.toFixed(2), total_expenses_usd: +totalExpUsd.toFixed(2), net_profit_usd: +(totalRevUsd - totalExpUsd).toFixed(2) }
}

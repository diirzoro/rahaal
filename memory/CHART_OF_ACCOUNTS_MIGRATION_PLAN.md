...
1. ❓ الترقيم يبدأ من `0001` أم `1000`؟ (المقترح: 0001)
2. ❓ 4 أرقام تسلسل تكفي (يدعم 9999 عميل لكل tenant) أم نستخدم 5 أرقام؟
3. ❓ هل الـMigration يشمل tenants كلها **دفعة واحدة**، أم tenant واحد للاختبار أولاً؟

**بعد اعتمادك للوثيقة والإجابات، ننطلق في التنفيذ الفعلي.**

---

*تم إعداد الوثيقة بواسطة رحّال ERP Engineering — v3.9.28*
